/PROG  ENABLE_NO_ANYBUS	  Macro
/ATTR
OWNER		= MNEDITOR;
COMMENT		= "ENABLE SCANNER";
PROG_SIZE	= 743;
CREATE		= DATE 23-10-27  TIME 15:18:24;
MODIFIED	= DATE 23-10-28  TIME 14:45:34;
FILE_NAME	= ENABLE_T;
VERSION		= 0;
LINE_COUNT	= 23;
MEMORY_SIZE	= 1039;
...
/MN
   ...
   2:  CALL FAULT_MESSAGE('No Anybus has been enabled.') ;
   3:  DO[55:OKUMA NO ANYBUS]=ON ;
